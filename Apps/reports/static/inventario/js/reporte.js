...
function generate_report() {
    ...
    $('<button type="button" class="btn btn-danger btnPDF" title="PDF"><a href="/reports/inventario/pdf/'+$('select[name="select_estado"]').val()+'/'+produc +'/" STYLE="color: white" target="_blank">Descargar Pdf <i class="fas fa-file-pdf"></i></a></button>').appendTo('div.dt-buttons');
}
