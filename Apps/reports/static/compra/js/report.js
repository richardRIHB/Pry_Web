...
function generate_report() {
    ...
    $('<button type="button" class="btn btn-danger btnPDF btn-sm btnTest" title="PDF"><a href="/reports/compra/pdf/'+ fecha_inicio +'/'+ fecha_final +'/'+ provee_pk +'/" STYLE="color: white" target="_blank">Descargar Pdf <i class="fas fa-file-pdf"></i></a></button>').appendTo('div.dt-buttons');
}
