...
function generate_report() {
    ...
    $('<button type="button" class="btn btn-danger btnPDF" title="PDF"><a href="/reports/cuentas/compra/pdf/'+ tipo_filtro +'/'+ provee +'/" STYLE="color: white" target="_blank">Descargar Pdf <i class="fas fa-file-pdf"></i></a></button>').appendTo('div.dt-buttons');
}
